...
export const metadata: Metadata = { title: 'Automatización con IA para empresas', description: 'Automatizamos tareas, documentos y flujos empresariales con inteligencia artificial, integraciones y control humano.', alternates: { canonical: '/automatizacion-ia' }, openGraph: { title: 'Automatización de procesos con IA para empresas', description: 'Detectamos e implantamos automatizaciones medibles, integradas y con supervisión humana.', url: '/automatizacion-ia', type: 'website' } }
