...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Software a medida o SaaS genérico', description: 'Cuándo un proceso interno necesita una herramienta propia y cuándo no.', url: '/recursos/software-a-medida-o-generico', type: 'article', images: ['/images/resource-software-operations.webp'] },
}
