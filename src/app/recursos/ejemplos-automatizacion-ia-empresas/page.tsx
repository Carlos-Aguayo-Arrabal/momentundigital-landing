...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Automatización con IA para empresas: ejemplos', description: 'Casos prácticos y criterios para elegir una automatización rentable.', url: '/recursos/ejemplos-automatizacion-ia-empresas', type: 'article', images: ['/images/resource-ai-automation.webp'] },
}
