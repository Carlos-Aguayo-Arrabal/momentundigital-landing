...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Cuánto cuesta desarrollar un SaaS', description: 'Partidas, alcance y costes ocultos que debes revisar antes de contratar.', url: '/recursos/cuanto-cuesta-desarrollar-saas', type: 'article', images: ['/images/resource-saas-planning.png'] },
}
