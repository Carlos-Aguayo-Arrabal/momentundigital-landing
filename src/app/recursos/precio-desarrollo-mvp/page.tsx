...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Precio de desarrollar un MVP', description: 'Qué determina la inversión de una primera versión funcional.', url: '/recursos/precio-desarrollo-mvp', type: 'article', images: ['/images/resource-mvp-path.webp'] },
}
