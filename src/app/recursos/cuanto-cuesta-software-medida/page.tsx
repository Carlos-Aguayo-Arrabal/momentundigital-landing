...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Cuánto cuesta un software de gestión a medida', description: 'Qué partidas debe incluir una propuesta seria de software interno.', url: '/recursos/cuanto-cuesta-software-medida', type: 'article', images: ['/images/resource-software-choice.webp'] },
}
